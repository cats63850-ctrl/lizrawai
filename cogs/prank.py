...
Права нужны настоящие: `mute` требует «Тайм-аут участников»,
`ban` — «Банить участников». Без них команда не сработает, и рядовой
...
class Prank(commands.Cog, name="Модерация"):
    ...
    @commands.hybrid_command(
        name="mute",
        aliases=["timeout", "fakemute"],
        description="Выдать участнику тайм-аут",
        hidden=True,
    )
    @app_commands.describe(
        target="Кого замьютить",
    ...
    @app_commands.describe(target="Кого забанить", reason="Причина")
    @commands.guild_only()
